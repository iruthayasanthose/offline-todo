...
(function () {
  ...
  if (Object.defineProperty)
    try {
      Object.defineProperty(e, "test", { enumerable: !1 }),
  ...
  (function (e) {
    function t(e, t, n, o) {
      (n.target = t),
        "function" == typeof t[e] && t[e].apply(t, [n]),
        "function" == typeof o && o();
    }
    function n(t, n, o) {
      ...
      throw (
        ((r.name = t),
        (r.message = n),
        e.DEBUG && (console.log(t, n, o, r), console.trace && console.trace()),
        r)
      );
    }
    var o = function () {
      (this.length = 0),
        (this._items = []),
        cleanInterface &&
          Object.defineProperty(this, "_items", { enumerable: !1 });
    };
    if (
      ((o.prototype = {
        contains: function (e) {
      ...
      for (var r in { indexOf: !1, push: !1, splice: !1 })
        Object.defineProperty(o.prototype, r, { enumerable: !1 });
    e.util = {
      throwDOMException: n,
      callback: t,
      quote: function (e) {
          ...
          function derez(e, t) {
            ...
            if (
              ...
              for (n = 0; objects.length > n; n += 1)
                if (objects[n] === e) return { $ref: paths[n] };
              if (
                (objects.push(e),
                paths.push(t),
                ...
                for (o in e)
                  Object.prototype.hasOwnProperty.call(e, o) &&
                    (r[o] = derez(e[o], t + "[" + JSON.stringify(o) + "]"));
              }
              return r;
            }
            return (
              e instanceof Blob
                ? (queuedObjects.push(t), readBlobAsDataURL(e, t))
                : e instanceof Boolean
                ? (e = { $type: "bool", $enc: "" + e })
                : e instanceof Date
                ? (e = { $type: "date", $enc: e.getTime() })
                : e instanceof Number
                ? (e = { $type: "num", $enc: "" + e })
                : e instanceof RegExp && (e = { $type: "regex", $enc: "" + e }),
              e
            );
          }
          var objects = [],
        ...
        retrocycle: function retrocycle($) {
          function dataURLToBlob(e) {
            ...
            for (var i = o.length, a = new Uint8Array(i), s = 0; i > s; ++s)
              a[s] = o.charCodeAt(s);
            return new Blob([a.buffer], { type: t });
          }
          function rez(value) {
  ...
  (function (e, t) {
    function n(n, o, r, i, a, s) {
      (this.__range = n),
        (this.source = this.__idbObjectStore = r),
        (this.__req = i),
        (this.key = t),
        (this.direction = o),
        (this.__keyColumnName = a),
        (this.__valueColumnName = s),
        (this.__valueDecoder = "value" === s ? e.Sca : e.Key),
        this.source.transaction.__active ||
          e.util.throwDOMException(
            "TransactionInactiveError - The transaction this IDBObjectStore belongs to is not active."
          ),
        (this.__offset = -1),
    ...
    (n.prototype.__find = function (n, o, r, i, a) {
      a = a || 1;
      var s = this,
        c = ["SELECT * FROM ", e.util.quote(s.__idbObjectStore.name)],
        u = [];
      c.push("WHERE ", s.__keyColumnName, " NOT NULL"),
        s.__range &&
          (s.__range.lower || s.__range.upper) &&
          (c.push("AND"),
          s.__range.lower &&
            (c.push(
              s.__keyColumnName + (s.__range.lowerOpen ? " >" : " >= ") + " ?"
            ),
            u.push(e.Key.encode(s.__range.lower))),
          s.__range.lower && s.__range.upper && c.push("AND"),
          s.__range.upper &&
            (c.push(
              s.__keyColumnName + (s.__range.upperOpen ? " < " : " <= ") + " ?"
            ),
            u.push(e.Key.encode(s.__range.upper)))),
        n !== t && ((s.__lastKeyContinued = n), (s.__offset = 0)),
        s.__lastKeyContinued !== t &&
          (c.push("AND " + s.__keyColumnName + " >= ?"),
          u.push(e.Key.encode(s.__lastKeyContinued))),
        c.push("ORDER BY ", s.__keyColumnName),
        c.push("LIMIT " + a + " OFFSET " + s.__offset),
        e.DEBUG && console.log(c.join(" "), u),
        ...
        o.executeSql(
          ...
          function (n, o) {
            o.rows.length > 1
              ? ((s.__prefetchedData = o.rows),
                (s.__prefetchedIndex = 0),
                e.DEBUG &&
                  console.log(
                    "Preloaded " +
                      s.__prefetchedData.length +
                      " records for cursor"
                  ),
                s.__decode(o.rows.item(0), r))
              : 1 === o.rows.length
              ? s.__decode(o.rows.item(0), r)
              : (e.DEBUG && console.log("Reached end of cursors"), r(t, t));
          },
          function (t, n) {
      ...
      (n.prototype.__decode = function (t, n) {
        var o = e.Key.decode(t[this.__keyColumnName]),
          r = this.__valueDecoder.decode(t[this.__valueColumnName]),
          i = e.Key.decode(t.key);
        n(o, r, i);
      }),
      (n.prototype["continue"] = function (n) {
        var o = e.cursorPreloadPackSize || 100,
          r = this;
        this.__idbObjectStore.transaction.__addToTransactionQueue(function (
          e,
          i,
          a,
          s
          ...
          var c = function (e, n, o) {
            (r.key = e),
              (r.value = n),
              (r.primaryKey = o),
              a(r.key !== t ? r : t, r.__req);
          };
          return r.__prefetchedData &&
            (r.__prefetchedIndex++,
            r.__prefetchedIndex < r.__prefetchedData.length)
            ? (r.__decode(r.__prefetchedData.item(r.__prefetchedIndex), c), t)
            : (r.__find(n, e, c, s, o), t);
        });
      }),
      (n.prototype.advance = function (n) {
        0 >= n &&
          e.util.throwDOMException(
            "Type Error - Count is invalid - 0 or negative",
            n
          );
        var o = this;
        this.__idbObjectStore.transaction.__addToTransactionQueue(function (
      ...
      (n.prototype.update = function (n) {
        var o = this,
          r = this.__idbObjectStore.transaction.__createRequest(function () {});
        return (
          e.Sca.encode(n, function (n) {
            o.__idbObjectStore.transaction.__pushToQueue(
              r,
              function (r, i, a, s) {
                o.__find(
                  t,
                  ...
                  function (t, i, c) {
                    var u =
                      "UPDATE " +
                      e.util.quote(o.__idbObjectStore.name) +
                      " SET value = ? WHERE key = ?";
                    e.DEBUG && console.log(u, n, t, c),
                      r.executeSql(
                        u,
                        [n, e.Key.encode(c)],
                        function (e, n) {
      ...
      (n.prototype["delete"] = function () {
        var n = this;
        return this.__idbObjectStore.transaction.__addToTransactionQueue(
          function (o, r, i, a) {
            n.__find(
              t,
              o,
              function (r, s, c) {
                var u =
                  "DELETE FROM  " +
                  e.util.quote(n.__idbObjectStore.name) +
                  " WHERE key = ?";
                e.DEBUG && console.log(u, r, c),
                  o.executeSql(
                    u,
                    [e.Key.encode(c)],
                    function (e, o) {
  ...
  (function (idbModules, undefined) {
    function IDBIndex(e, t) {
      ...
      n && (n = JSON.parse(n)),
        (this.keyPath = (n && n[e] && n[e].keyPath) || e),
        ["multiEntry", "unique"].forEach(function (t) {
          this[t] = !!(
            n &&
            n[e] &&
            n[e].optionalParams &&
            n[e].optionalParams[t]
          );
        }, this);
    }
    (IDBIndex.prototype.__createIndex = function (
      indexName,
      keyPath,
      optionalParameters
    ) {
      ...
      transaction.__addToTransactionQueue(function (
        ...
        me.__idbObjectStore.__getStoreProps(
          tx,
          function () {
            function error() {
              idbModules.util.throwDOMException(
                0,
                "Could not create new index",
                arguments
              );
            }
            2 !== transaction.mode &&
              idbModules.util.throwDOMException(
                0,
                "Invalid State error, not a version transaction",
                me.transaction
              );
            var idxList = JSON.parse(
              me.__idbObjectStore.__storeProps.indexList
            );
            idxList[indexName] !== undefined &&
              idbModules.util.throwDOMException(
                0,
                    ...
                    function (tx, data) {
                      (function initIndexForRow(i) {
                        if (data.rows.length > i)
                          try {
                            var value = idbModules.Sca.decode(
                                data.rows.item(i).value
                              ),
                              indexKey = eval("value['" + keyPath + "']");
                            tx.executeSql(
                              "UPDATE " +
                                idbModules.util.quote(
                                  me.__idbObjectStore.name
                                ) +
                                " set " +
                                columnName +
                                " = ? where key = ?",
                          ...
                          idbModules.DEBUG &&
                            console.log(
                              "Updating the indexes in table",
                              me.__idbObjectStore.__storeProps
                            ),
                            tx.executeSql(
                              "UPDATE __sys__ set indexList = ? where name = ?",
                              [
                                me.__idbObjectStore.__storeProps.indexList,
                                me.__idbObjectStore.name,
                              ],
                              function () {
                                me.__idbObjectStore.__setReadyState(
                                  "createIndex",
                                  !0
                                ),
                                  success(me);
      ...
      (IDBIndex.prototype.openKeyCursor = function (e, t) {
        var n = new idbModules.IDBRequest();
        return (
          new idbModules.IDBCursor(e, t, this.source, n, this.indexName, "key"),
          n
        );
      }),
      (IDBIndex.prototype.__fetchIndexData = function (e, t) {
        var n = this;
        return n.__idbObjectStore.transaction.__addToTransactionQueue(function (
          o,
          r,
          i,
          a
          ...
          var s = [
              "SELECT * FROM ",
              idbModules.util.quote(n.__idbObjectStore.name),
              " WHERE",
              n.indexName,
              "NOT NULL",
            ],
            c = [];
          e !== undefined &&
            (s.push("AND", n.indexName, " = ?"),
            c.push(idbModules.Key.encode(e))),
            idbModules.DEBUG &&
              console.log("Trying to fetch data for Index", s.join(" "), c),
            o.executeSql(
              s.join(" "),
              c,
              function (e, n) {
                ...
                (o =
                  "count" === t
                    ...
                    ? undefined
                    : "key" === t
                    ? idbModules.Key.decode(n.rows.item(0).key)
                    : idbModules.Sca.decode(n.rows.item(0).value)),
                  i(o);
              },
              a
            );
  ...
  (function (idbModules) {
    var IDBObjectStore = function (e, t, n) {
      (this.name = e),
        (this.transaction = t),
        (this.__ready = {}),
        this.__setReadyState("createObjectStore", n === void 0 ? !0 : n),
    ...
    (IDBObjectStore.prototype.__setReadyState = function (e, t) {
      ...
      (IDBObjectStore.prototype.__getStoreProps = function (e, t, n) {
        ...
        this.__waitForReady(function () {
          o.__storeProps
            ? (idbModules.DEBUG &&
                console.log("Store properties - cached", o.__storeProps),
              t(o.__storeProps))
            : e.executeSql(
                "SELECT * FROM __sys__ where name = ?",
                [o.name],
                function (e, n) {
                  1 !== n.rows.length
                    ? t()
                    : ((o.__storeProps = {
                      ...
                      idbModules.DEBUG &&
                        console.log("Store properties", o.__storeProps),
                      t(o.__storeProps));
                },
                function () {
                  t();
      ...
      (IDBObjectStore.prototype.__deriveKey = function (
        tx,
        value,
        key,
        callback
        ...
        function getNextAutoIncKey() {
          tx.executeSql(
            "SELECT * FROM sqlite_sequence where name like ?",
            [me.name],
            function (e, t) {
            ...
            function (e, t) {
              idbModules.util.throwDOMException(
                0,
                "Data Error - Could not get the auto increment value for key",
                t
              );
            }
          );
        ...
        me.__getStoreProps(tx, function (props) {
          if (
            (props ||
              idbModules.util.throwDOMException(
                0,
                "Data Error - Could not locate defination for this table",
                props
              ),
            props.keyPath)
          )
            if (
              (key !== void 0 &&
                idbModules.util.throwDOMException(
                  0,
                  "Data Error - The object store uses in-line keys and the key parameter was provided",
                  props
                ),
              value)
            )
              try {
                ...
                primaryKey
                  ...
                  : idbModules.util.throwDOMException(
                      0,
                      "Data Error - Could not eval key from keyPath"
                    );
              } catch (e) {
                idbModules.util.throwDOMException(
                  0,
              ...
              idbModules.util.throwDOMException(
                0,
                "Data Error - KeyPath was specified, but value was not"
              );
          else
            key !== void 0
              ? callback(key)
              ...
              ? idbModules.util.throwDOMException(
                  0,
                  "Data Error - The object store uses out-of-line keys and has no key generator and the key parameter was not provided. ",
                  props
                )
              : getNextAutoIncKey();
        });
      }),
      (IDBObjectStore.prototype.__insertData = function (
        tx,
        encoded,
        value,
        primaryKey,
        ...
        for (var key in indexes)
          try {
            paramMap[indexes[key].columnName] = idbModules.Key.encode(
              eval("value['" + indexes[key].keyPath + "']")
            );
          } catch (e) {
            error(e);
          }
      ...
      (IDBObjectStore.prototype.add = function (e, t) {
        ...
        return (
          idbModules.Sca.encode(e, function (r) {
          ...
          idbModules.Sca.encode(e, function (r) {
            n.transaction.__pushToQueue(o, function (o, i, a, s) {
              n.__deriveKey(o, e, t, function (t) {
                var i =
                  "DELETE FROM " +
                  idbModules.util.quote(n.name) +
                  " where key = ?";
                o.executeSql(
                  i,
                  [idbModules.Key.encode(t)],
                  function (o, i) {
                    idbModules.DEBUG &&
                      console.log(
      ...
      (IDBObjectStore.prototype.get = function (e) {
        ...
        return t.transaction.__addToTransactionQueue(function (n, o, r, i) {
          t.__waitForReady(function () {
            ...
            idbModules.DEBUG && console.log("Fetching", t.name, o),
              n.executeSql(
                "SELECT * FROM " +
                  idbModules.util.quote(t.name) +
                  " where key = ?",
                [o],
                function (e, t) {
                  idbModules.DEBUG && console.log("Fetched data", t);
                  try {
                    if (0 === t.rows.length) return r();
                    r(idbModules.Sca.decode(t.rows.item(0).value));
                  } catch (n) {
                    idbModules.DEBUG && console.log(n), r(void 0);
                  }
                },
                function (e, t) {
                  i(t);
          ...
          t.__waitForReady(function () {
            ...
            idbModules.DEBUG && console.log("Fetching", t.name, o),
              n.executeSql(
                ...
                function (e, t) {
                  idbModules.DEBUG &&
                    console.log("Deleted from database", t.rowsAffected),
                    r();
                },
                function (e, t) {
                  i(t);
      ...
      (IDBObjectStore.prototype.clear = function () {
        ...
        return e.transaction.__addToTransactionQueue(function (t, n, o, r) {
          e.__waitForReady(function () {
            t.executeSql(
              "DELETE FROM " + idbModules.util.quote(e.name),
              [],
              function (e, t) {
                idbModules.DEBUG &&
                  console.log(
        ...
        return t.transaction.__addToTransactionQueue(function (n, o, r, i) {
          t.__waitForReady(function () {
            var o =
                ...
                (e !== void 0 ? " WHERE key = ?" : ""),
              a = [];
            e !== void 0 && a.push(idbModules.Key.encode(e)),
              n.executeSql(
                o,
                a,
                function (e, t) {
      ...
      r = function (o, r, i) {
        if ("number" == typeof r)
          (this.mode = r),
            2 !== r &&
              e.DEBUG &&
              console.log("Mode should be a string, but was specified as ", r);
        ...
        for (var a = 0; this.storeNames.length > a; a++)
          i.objectStoreNames.contains(this.storeNames[a]) ||
            e.util.throwDOMException(
              0,
    ...
    (r.prototype.__executeRequests = function () {
      if (this.__running && this.mode !== o)
        return (
          e.DEBUG &&
            console.log(
              "Looks like the request set is already running",
              this.mode
            ),
          void 0
        );
        ...
        2 === t.mode ||
          ...
          t.db.__db.transaction(
            function (n) {
              ...
              function i() {
                return s >= t.__requests.length
                  ? ((t.__active = !1), (t.__requests = []), void 0)
                  : ((a = t.__requests[s]), a.op(n, a.args, o, r), void 0);
              }
              t.__tx = n;
              var a = null,
                s = 0;
              try {
                ...
                e.DEBUG &&
                  console.log("An exception occured in transaction", arguments),
      ...
      (r.prototype.__pushToQueue = function (e, t, n) {
        this.__requests.push({ op: t, args: n, req: e }),
      ...
      (r.prototype.READ_ONLY = 0),
      (r.prototype.READ_WRITE = 1),
      (r.prototype.VERSION_CHANGE = 2),
      (e.IDBTransaction = r);
  })(idbModules),
  (function (e) {
    ...
    (t.prototype.createObjectStore = function (t, n) {
      ...
      var r = new e.IDBObjectStore(t, o.__versionTransaction, !1),
        i = o.__versionTransaction;
      return (
        i.__addToTransactionQueue(function (i, a, s) {
          function c() {
            e.util.throwDOMException(
              0,
              "Could not create new object store",
              arguments
            );
          }
          o.__versionTransaction ||
            e.util.throwDOMException(0, "Invalid State error", o.transaction);
          var u = [
            "CREATE TABLE",
            e.util.quote(t),
            "(key BLOB",
          ...
          e.DEBUG && console.log(u),
            i.executeSql(
              u,
              [],
              function (e) {
                e.executeSql(
                  "INSERT INTO __sys__ VALUES (?,?,?,?)",
                  [t, n.keyPath, n.autoIncrement ? !0 : !1, "{}"],
                  function () {
      ...
      (t.prototype.deleteObjectStore = function (t) {
        var n = function () {
            e.util.throwDOMException(
              0,
              "Could not delete ObjectStore",
              arguments
            );
          },
          o = this;
        !o.objectStoreNames.contains(t) && n("Object Store does not exist"),
          o.objectStoreNames.splice(o.objectStoreNames.indexOf(t), 1);
            ...
            o.__db.transaction(function (o) {
              o.executeSql(
                ...
                function (o, r) {
                  r.rows.length > 0 &&
                    o.executeSql(
                      "DROP TABLE " + e.util.quote(t),
                      [],
                      function () {
                        o.executeSql(
                          "DELETE FROM __sys__ WHERE name = ?",
                          [t],
                          function () {},
                          n
                        );
    ...
    if (window.openDatabase) {
      ...
      n.transaction(
            ...
            function () {
              n.transaction(function (t) {
                t.executeSql(
                  ...
                  function () {
                    e.util.throwDOMException(
                      "Could not create table __sysdb__ to save DB versions"
                    );
                  }
                );
              });
        ...
        function () {
          e.DEBUG &&
            console.log(
              "Error in sysdb transaction - when selecting from dbVersions",
              arguments
            );
        }
      );
        ...
        open: function (o, r) {
          ...
          function a(a) {
            ...
            (s.readyState = "done"),
              ...
              c.transaction(function (t) {
                t.executeSql(
                  "CREATE TABLE IF NOT EXISTS __sys__ (name VARCHAR(255), keyPath VARCHAR(255), autoInc BOOLEAN, indexList BLOB)",
                  [],
                  function () {
                    t.executeSql(
                      "SELECT * FROM __sys__",
                      ...
                      function (t, u) {
                        ...
                        (s.source = s.result = new e.IDBDatabase(c, o, r, u)),
                          r > a
                            ? n.transaction(function (t) {
                                t.executeSql(
                                  ...
                                  function () {
                                    ...
                                    (t.oldVersion = a),
                                      (t.newVersion = r),
                                      (s.transaction =
                                        s.result.__versionTransaction =
                                          new e.IDBTransaction(
                                            [],
                                            2,
                                            s.source
                                          )),
          ...
          return (
            n.transaction(function (e) {
              e.executeSql(
                "SELECT * FROM dbVersions where name = ?",
                [o],
                function (e, t) {
                  0 === t.rows.length
                    ? e.executeSql(
                      ...
                      function (t, n) {
                        ...
                        (function a(n) {
                          n >= o.length
                            ...
                            : t.executeSql(
                                "DROP TABLE " + e.util.quote(o.item(n).name),
                                [],
                                function () {
                                  a(n + 1);
                                },
  ...
  (function (e, t) {
    e.openDatabase !== void 0 &&
      ((e.shimIndexedDB = t.shimIndexedDB),
      e.shimIndexedDB &&
        ((e.shimIndexedDB.__useShim = function () {
          (e.indexedDB = t.shimIndexedDB),
            ...
            e.indexedDB !== t.shimIndexedDB &&
              ...
              Object.defineProperty(e, "indexedDB", { value: t.shimIndexedDB });
        }),
    ...
    if (
      ((navigator.userAgent.match(/Android 2/) ||
        ...
        (navigator.userAgent.match(/Chrome/) || (n = !0)),
      (void 0 !== e.indexedDB && !n) || void 0 === e.openDatabase)
    ) {
      ...
      try {
        (e.IDBTransaction.READ_ONLY = e.IDBTransaction.READ_ONLY || "readonly"),
          (e.IDBTransaction.READ_WRITE =
            e.IDBTransaction.READ_WRITE || "readwrite");
      } catch (o) {}
